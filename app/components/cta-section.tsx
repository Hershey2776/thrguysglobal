    ...
    <section ref={containerRef} className="py-32 px-6 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
            <span className="text-white">Got an </span>
            <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">idea?</span>
            <br />
            <span className="text-white">A </span>
            <span className="bg-gradient-to-r from-pink-400 to-red-400 bg-clip-text text-transparent">challenge?</span>
            <br />
            <span className="text-white">A </span>
      ...
      >
        <motion.a
          ...
          rel="noopener noreferrer"
          whileTap={{ scale: 0.95 }}
          className="w-full bg-gradient-to-r from-purple-600 to-pink-600 py-4 rounded-full font-bold text-lg shadow-lg backdrop-blur-sm block text-center"
        >
          Let's Talk
        </motion.a>
      </motion.div>
